function calculate() {
    ...
    divAnswer.innerHTML += `<div class="answer predecessor">O número <strong>${userInput-1}</strong> é o antecessor de ${userInput}!</div>`;
    divAnswer.innerHTML += `<div class="answer successor">O sucessor de ${userInput} é <strong>${userInput+1}</strong>!</div>`;
}