function sendInfo() {
    ...
    if (getInputUser.length == "") {

        divAnswerUser.innerHTML = `<div class="answer error">É NECESSÁRIO DIGITAR ALGUM VALOR!</div>`

    } else {

        divAnswerUser.innerHTML = "";
        ...
        divAnswerUser.innerHTML += `<div class="answer">É alfa numérico? <strong><em>${getInputUser.match(/[a-z]/g) && getInputUser.match(/[0-9]/) == true}</em></strong>!</div>`;
